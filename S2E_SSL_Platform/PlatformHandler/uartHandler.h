...
//#defien UART_IF_TTL
//#defien UART_IF_RS232
#define UART_IF_RS422                   0
#define UART_IF_RS485                   1
#define UART_IF_RS485_REVERSE           2
...
int32_t uart_putc(uint8_t uartNum, uint16_t ch);                    // User Buffer -> UART
int32_t uart_getc(uint8_t uartNum);                                 // Ring Buffer -> User
...
uint8_t get_byte_from_uart(uint8_t uartNum);                        // UART Port -> User
void get_byte_from_uart_it(uint8_t uartNum);                        // UART Port -> User (global variable for IRQ handler)
void put_byte_to_uart_buffer(uint8_t uartNum, uint8_t ch);          // User -> Ring Buffer
...
void uart_rx_flush(uint8_t uartNum);                                // UART buffer flush
...
////////////////////////////////////////////////////////////////////////////////////////////////////
// Defines: WIZ2000 UART Ring buffer
////////////////////////////////////////////////////////////////////////////////////////////////////
